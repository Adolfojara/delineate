...
setup(
    ...
    install_requires=[
        "numpy>=1.18.1",
        "scipy>=1.4.1",
        # "DendroPy @ git+https://git@github.com/jeetsukumaran/DendroPy.git#egg=DendroPy",
        "DendroPy @ git+https://git@github.com/jeetsukumaran/DendroPy.git@main#egg=DendroPy",
        ],
)
